...
MMGEN_CACHE_DIR = os.path.expanduser("~") + "/.cache/openmmlab/mmdp/"
...
def get_content_from_url(url, timeout=15, stream=False):
    ...
    """
    try:
        response = req.get(url, timeout=timeout, stream=stream)
