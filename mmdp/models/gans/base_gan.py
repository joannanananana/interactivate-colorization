...
class BaseGAN(nn.Module, metaclass=ABCMeta):
    ...
    def with_gen_auxiliary_loss(self):
        ...
        return hasattr(self, "gen_auxiliary_losses") and (
            self.gen_auxiliary_losses is not None
        )
    ...
    def with_disc_auxiliary_loss(self):
        ...
        return (
            hasattr(self, "disc_auxiliary_losses")
    ...
    def sample_from_noise(
        self, noise, num_batches=0, sample_model="ema/orig", **kwargs
    ):
