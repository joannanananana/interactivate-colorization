...
class SRGAN(BasicRestorer):
    ...
    def __init__(
        ...
        # discriminator
        self.discriminator = build_module(discriminator) if discriminator else None

        # support fp16
        self.fp16_enabled = False

        # loss
        self.gan_loss = build_module(gan_loss) if gan_loss else None
        ...
        self.codebook_loss = build_module(codebook_loss) if codebook_loss else None
    ...
    def init_weights(self, pretrained=None):
        ...
        )  # quantsr models have init_weights
