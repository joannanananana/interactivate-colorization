...
class FeMaSRNet(nn.Module):
    def __init__(
        ...
        **ignore_kwargs,
        ...
        self.LQ_stage = LQ_stage
        self.frozen_module_keywords = frozen_module_keywords
    ...
    def encode_and_decode(self, input, gt_indices=None, current_iter=None):
        ...
        return out_img, out_img, codebook_loss, semantic_loss, indices_list
    ...
    def test_tile(self, input, tile_size=240, tile_pad=16):
        ...
        """It will first crop input images to tiles, and then process each
        tile.
    ...
    def forward(self, input, gt_indices=None):
        ...
        if gt_indices is not None:
            ...
            img, dec, codebook_loss, semantic_loss, indices = self.encode_and_decode(
                input, gt_indices
            )
        else:
        ...
        return img, dec, codebook_loss, semantic_loss, indices
