...
from mmdp.apis import init_model, restoration_inference
from mmdp.models.misc import tensor2img
from mmdp.utils import modify_args
...
def parse_args():
    ...
    parser.add_argument("--ref-path", default=None, help="path to reference image file")
...
def main():
    ...
    if not os.path.isfile(args.img_path):
        raise ValueError(
            "It seems that you did not input a valid "
