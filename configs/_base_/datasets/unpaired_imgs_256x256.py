...
train_pipeline = [
    dict(
        type="LoadImageFromFile", io_backend="disk", key=f"img_{domain_a}", flag="color"
    ),
    dict(
        type="LoadImageFromFile", io_backend="disk", key=f"img_{domain_b}", flag="color"
    ),
    dict(
        type="Resize",
...
test_pipeline = [
    dict(type="LoadImageFromFile", io_backend="disk", key="image", flag="color"),
    dict(type="Resize", keys=["image"], scale=(256, 256), interpolation="bicubic"),
