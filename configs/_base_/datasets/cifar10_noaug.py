...
data = dict(
    ...
    train=dict(
        ...
        times=500,
        dataset=dict(
            type=dataset_type, data_prefix="data/cifar10", pipeline=train_pipeline
        ),
    ),
    val=dict(type=dataset_type, data_prefix="data/cifar10", pipeline=test_pipeline),
    test=dict(type=dataset_type, data_prefix="data/cifar10", pipeline=test_pipeline),
)
