...
from mmdp.apis import multi_gpu_test, set_random_seed, single_gpu_test
from mmdp.core.distributed_wrapper import DistributedDataParallelWrapper
from mmdp.datasets import build_dataloader, build_dataset
from mmdp.models import build_model


def parse_args():
    parser = argparse.ArgumentParser(description="mmdp tester")
